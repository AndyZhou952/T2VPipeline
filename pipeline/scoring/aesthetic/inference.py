# - This file is adapted from https://github.com/hpcaitech/Open-Sora/blob/main/tools/scoring/aesthetic/inference.py
# - MindSpore version
...
class AestheticScorer(nn.Cell):
    ...
    def construct(self, x):
        ...
        # image_features = Tensor(normalize(image_features).astype(np.float32))
