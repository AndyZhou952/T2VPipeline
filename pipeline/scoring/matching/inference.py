# - This file is adapted from https://github.com/hpcaitech/Open-Sora/blob/main/tools/scoring/matching/inference.py
# - MindSpore version
...
class VideoTextDataset:
    ...
    def __getitem__(self, index):
        ...
        Args:
            ...
            - predefined list in .txt or .csv files # TODO: may need to support from .txt (multiple strings)
