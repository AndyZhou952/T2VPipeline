# - This file is adapted from https://github.com/hpcaitech/Open-Sora/blob/main/tools/datasets/datautil.py
...
from pipeline.datasets.utils import IMG_EXTENSIONS, VID_EXTENSIONS
