# - This file is adapted from https://github.com/hpcaitech/Open-Sora/blob/main/tools/scene_cut/scene_detect.py
# - We provide additional scene detect option using ContentDetector similar to the one used in gathering Panda-70M
